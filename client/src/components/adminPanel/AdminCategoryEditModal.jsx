...
const AdminCategoryEditModal = ({ open, setOpen, category }) => {
  const {updateCategoryApi} = useCategoryServices();

console.log('category from modal', category) 
  ...
  const handleSubmit = (e) => {
    ...
    updateCategoryApi(category?._id, inputs);
